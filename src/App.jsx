...
const MODULES = [
  {
    ...
    icon: Cloud,
    colour: "bg-[#3E2368]",
    users: ["all", "it", "management"],
    bullets: [
      { text: "User, role and access management", users: ["it", "management"] },
      { text: "Security, permissions and platform governance", users: ["it", "management"] },
      { text: "Environment management for test, training and production", users: ["it"] },
      { text: "Common foundation that supports Connect, Mobilise, ALM and FSI", users: ["all"] },
      { text: "Integration layer enabling information to move across the solution", users: ["it", "management"] },
    ],
  },
  {
    id: "connect",
    ...
    colour: "bg-[#009FE3]",
    users: ["operative", "planner", "customer", "commercial", "compliance", "management", "asset", "it"],
    bullets: [
      { text: "Create and manage work orders, repairs, void jobs, compliance activities and investment works", users: ["planner", "customer", "compliance", "asset", "management"] },
      { text: "Schedule, dispatch and allocate work to operatives or contractors", users: ["planner", "operative", "management", "asset"] },
      { text: "Manage contracts, suppliers, subcontractors, materials and stock", users: ["commercial", "planner", "management", "asset"] },
      { text: "Apply workflow rules, priorities, SLAs, diagnostic rules and approvals", users: ["planner", "compliance", "customer", "management", "asset"] },
      { text: "Receive job updates from Mobilise and feed performance information into reporting", users: ["management", "planner", "it", "asset"] },
      { text: "Support purchase order, supplier and subcontractor processing", users: ["commercial", "it", "asset"] },
    ],
  },
  {
    id: "mobilise",
    ...
    icon: Smartphone,
    colour: "bg-[#E6007E]",
    users: ["operative", "surveyor", "compliance", "sustainability", "asset", "planner", "management"],
    bullets: [
      ...
      { text: "Work online and offline, then sync updates back into Connect", users: ["operative", "surveyor", "planner"] },
      { text: "Capture shift, visit outcome and productivity data for performance insight", users: ["operative", "management"] },
      { text: "Capture EPC, SAP, RdSAP and retrofit survey information on site", users: ["sustainability", "surveyor", "asset"] },
    ],
  },
  {
    id: "alm",
    ...
    icon: Database,
    colour: "bg-[#95C11F]",
    users: ["asset", "surveyor", "compliance", "sustainability", "planner", "management", "it"],
    bullets: [
      { text: "Store property, component, condition, compliance, hierarchy and lifecycle data", users: ["asset", "compliance", "management"] },
      { text: "Maintain asset hierarchies such as property, block, communal area and component relationships", users: ["asset", "it"] },
      { text: "Support stock condition data, decent homes, component replacement and long-term investment planning", users: ["asset", "surveyor", "management", "sustainability"] },
      { text: "Support programme grouping, batch issuing and contractor delivery planning", users: ["asset", "management", "commercial"] },
      { text: "Enable lifecycle forecasting, feasibility analysis and midlife scope adjustments", users: ["asset", "management"] },
      { text: "Provide asset context back into Connect so jobs are linked to the right property and component", users: ["planner", "operative", "asset", "it"] },
      { text: "Store compliance, risk and certification information against the property record", users: ["compliance", "asset", "management"] },
      { text: "Manage EPC, SAP, RdSAP, energy data and SAVA integration for sustainability planning", users: ["sustainability", "asset", "it"] },
    ],
  },
  {
    id: "fsi",
    ...
    icon: BarChart3,
    colour: "bg-[#F9B233]",
    users: ["management", "planner", "compliance", "commercial", "asset", "sustainability", "operative"],
    bullets: [
      { text: "Dashboards for jobs, SLAs, first-time fix, productivity and utilisation", users: ["management", "planner", "operative"] },
      { text: "Compliance KPIs, overdue actions, audit readiness and risk visibility", users: ["compliance", "management"] },
      { text: "Void turnaround, repair performance and programme delivery tracking", users: ["planner", "management", "asset"] },
      { text: "Cost, usage, materials and supplier analytics", users: ["commercial", "management"] },
      { text: "Investment planning, lifecycle, programme performance and cost-versus-plan reporting", users: ["asset", "management", "commercial"] },
      { text: "Track contractor KPIs, delivery performance and programme milestones", users: ["asset", "management", "commercial"] },
      { text: "Sustainability reporting such as SHDF, carbon metrics and energy efficiency progress", users: ["sustainability", "management"] },
    ],
  },
  {
    id: "integration",
    ...
    icon: PlugZap,
    colour: "bg-slate-500",
    users: ["it", "customer", "commercial", "sustainability", "management", "planner", "asset", "compliance"],
    bullets: [
      { text: "Exchange work order, customer, property, appointment, asset and compliance data", users: ["it", "planner", "customer", "asset", "compliance"] },
      { text: "Connect with D365, OpenHousing, Proactis, tenant portal and document systems", users: ["it", "customer", "management"] },
      { text: "Supplier integrations with CEF, Rexel and Travis Perkins for purchase orders, stock and invoices", users: ["commercial", "it"] },
      { text: "SAVA integration for RdSAP submissions and EPC certificate returns", users: ["sustainability", "asset", "it"] },
      { text: "Message bus and middleware flows to support real-time or scheduled data movement", users: ["it", "management"] },
      { text: "Secure API access, validation rules and controlled data exchange", users: ["it"] },
    ],
  },
];
...
const PROCESSES = [
  {
    ...
    users: ["operative", "planner", "customer", "management", "commercial"],
    steps: ["Raise repair", "Schedule & dispatch", "Complete visit", "Capture evidence", "Close & report"],
    modules: "Connect → Mobilise → ALM → FSI → Integration",
  },
  {
    title: "Voids",
    users: ["surveyor", "operative", "planner", "asset", "management"],
    steps: ["Survey void", "Plan works", "Complete repairs", "Inspect & sign off", "Handover"],
    modules: "Connect → Mobilise → ALM → FSI → Integration",
  },
  {
    title: "Compliance",
    users: ["compliance", "surveyor", "operative", "planner", "management"],
    steps: ["Plan programme", "Inspect", "Store certificate", "Track overdue", "Audit/report"],
    modules: "Connect → Mobilise → ALM → FSI → Integration",
  },
  {
    title: "Investment / Capital Works",
    users: ["asset", "surveyor", "planner", "commercial", "management", "sustainability", "it"],
    steps: ["Plan programme", "Group & issue projects", "Survey", "Deliver works", "QA checks", "Track spend & KPIs"],
    modules: "ALM → Connect → Mobilise → FSI → Integration",
  },
  {
    title: "Commercial / Materials",
    users: ["commercial", "operative", "planner", "management", "it", "asset"],
    steps: ["Create PO", "Validate operative", "Confirm order", "GRN / invoice", "Analyse usage"],
    modules: "Connect → Suppliers → Integration → FSI",
  },
  {
    title: "Energy / Sustainability",
    users: ["sustainability", "surveyor", "asset", "management", "it"],
    steps: ["Capture EPC/SAP data", "Submit to SAVA", "Receive EPC", "Plan retrofit", "Track carbon"],
    modules: "Mobilise → ALM → SAVA → FSI → Connect",
  },
];

const BENEFITS = [
  { text: "One version of the truth", users: ["all", "asset", "management", "compliance", "it"] },
  { text: "Less duplicated entry and chasing updates", users: ["operative", "planner", "customer", "commercial"] },
  { text: "Better evidence, audit trail and compliance confidence", users: ["compliance", "surveyor", "management"] },
  { text: "Mobile-first working and real-time job updates", users: ["operative", "surveyor", "planner"] },
  { text: "Smarter home investment planning, lifecycle forecasting and programme prioritisation", users: ["asset", "management", "sustainability", "commercial"] },
  { text: "Better contractor performance visibility and SLA management", users: ["asset", "management", "commercial"] },
  { text: "Improved cost visibility and supplier control", users: ["commercial", "management", "asset"] },
  { text: "Stronger reporting without spreadsheet collation", users: ["management", "planner", "compliance", "asset"] },
];
...
function filterModules(query) {
  ...
  return MODULES.filter((module) => {
    const searchableText = [module.title, module.subtitle, ...module.replaces, ...module.bullets.map((bullet) => bullet.text)]
      .join(" ")
      .toLowerCase();
...
function HighlightWrapper({ users, selected, dim, children }) {
  ...
  return (
    <motion.div
      animate={{ opacity: active ? 1 : 0.16, scale: dim && selected !== "all" && active ? 1.006 : 1 }}
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center gap-3 rounded-2xl border px-3 py-2 text-left transition ${
                      isActive ? "border-[#3E2368] bg-[#3E2368] text-white shadow-md" : "border-[#DED8EA] bg-white hover:border-[#95C11F] hover:bg-[#F6F4FA]"
                    }`}
                  >
          ...
          <section className="rounded-3xl border border-[#DED8EA] bg-white p-4 shadow-sm">
            <div className="mb-5 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="text-sm text-[#4D4658]">Relevant cards and lines are highlighted using a softer Platform-style palette.</p>
              </div>
              <div className="flex flex-col gap-2 sm:flex-row">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-[#DED8EA] py-2 pl-10 pr-3 text-sm outline-none focus:border-[#3E2368] sm:w-64"
                  />
                </div>
                <button
                  type="button"
                  onClick={() => setDimIrrelevant((current) => !current)}
                  className="inline-flex items-center justify-center gap-2 rounded-2xl border border-[#DED8EA] px-3 py-2 text-sm font-semibold text-[#3E2368] hover:bg-[#F6F4FA]"
                >
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-[#DED8EA] bg-gradient-to-br from-white to-[#F6F4FA] p-4">
              ...
              {filteredModules.length === 0 && (
                <div className="rounded-3xl border border-dashed border-[#DED8EA] bg-white p-8 text-center text-sm font-semibold text-[#6B6475]">
                  ...
                  <div className={`h-full rounded-3xl border p-4 ${processRelevant ? "border-[#95C11F]/40 bg-[#95C11F]/10 shadow-sm" : "border-[#DED8EA] bg-[#F6F4FA]"}`}>
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {process.steps.map((step, index) => (
                        <span key={step} className="rounded-full bg-white px-3 py-1 text-xs font-semibold text-[#3E2368] ring-1 ring-[#DED8EA]">
                          {index + 1}. {step}
                        </span>
                      ))}
                    </div>
        ...
        <section className="grid gap-4 xl:grid-cols-[1fr_320px]">
          ...
          <div className="rounded-3xl border border-[#DED8EA] bg-white p-5 shadow-sm">
            ...
            <div className="space-y-3 text-sm text-[#4D4658]">
              ...
              <p><strong>2.</strong> Relevant modules, bullets, processes and benefits stay prominent.</p>
              <p><strong>3.</strong> Use this in workshops to explain “what changes for me?” rather than showing every module at once.</p>
      ...
      <div className={`rounded-2xl border p-3 transition ${moduleRelevant ? "border-[#95C11F]/40 bg-white shadow-md" : "border-[#DED8EA] bg-white"}`}>
        ...
        <div className="mt-3 rounded-2xl border border-[#3E2368]/10 bg-[#3E2368]/5 p-3">
          ...
          <div className="flex flex-wrap gap-1.5">
            {module.replaces.map((item) => (
              <span key={item} className="rounded-full bg-white px-2 py-1 text-[11px] font-semibold text-[#3E2368] ring-1 ring-[#3E2368]/10">
                {item}
              </span>
            ))}
          </div>
        ...
        <div className="mt-3 space-y-1.5">
          {module.bullets.map((bullet) => {
            ...
            return (
              <motion.div
                key={bullet.text}
                animate={{ opacity: selected === "all" || bulletRelevant ? 1 : 0.2 }}
                transition={{ duration: 0.2 }}
                className={`flex gap-2 rounded-xl px-2 py-1 text-[13px] leading-snug ${bulletRelevant && selected !== "all" && dim ? "bg-[#95C11F]/15 ring-1 ring-[#95C11F]/25" : ""}`}
              >
